...
Pod::Spec.new do |spec|
  ...
  iOS Category from UILable UIButton UIImageView,
  iOS Objective-C NSDictionary and json transfor model
                   DESC

  spec.homepage     = "https://github.com/semperhhh/PHTool"
  ...
  spec.source       = { :git => "https://github.com/semperhhh/PHTool.git", :tag => "v#{spec.version}" }
